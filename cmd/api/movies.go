...
import (
	...
	"github.com/cozycole/greenlight/internal/validator"
)
...
func (app *application) updateMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	// This allows the client to ensure that their working with the most recent version
	// data if they supply their expected version
